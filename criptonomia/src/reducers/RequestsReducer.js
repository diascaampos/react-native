...
export default (state = INITIAL_STATE, action) =>{
    ...
    switch(action.type){
        ...
        case ALTERAR_STATUS_PAYMENT_LOADING:{
            return {... state, msg: '', loadingRequest:action.payload}
        }
        case BUSCAR_TOKEN_PAYMENT_SUCESSO:{
            return {... state, msg: '', token:action.payload}
        }
        case BUSCAR_TOKEN_PAYMENT_ERRO:{
            return {... state, msg: action.payload, loadingRequest: false}
        }
        case PAYMENT_ERRO:{
            return {... state, msg: action.payload, loadingRequest: false}
        }
        case PAYMENT_SUCESSO:{
            return {... state, msg: '', dadosPayment: action.payload, loadingRequest: false}
        }
