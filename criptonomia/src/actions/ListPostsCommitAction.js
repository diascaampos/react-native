...
export const listCommitPost = (id) => {
    return dispatch => {
        axios.get('https://jsonplaceholder.typicode.com/posts/'+id+'/comments', 
        {
            ...
            if(response.data != undefined){
                ...
                listCommitPostSucesso(response.data, dispatch);
            }
            ...
            listCommitPostErro('Não foi possível conectar com o servidor, verifique sua internet!', dispatch);
        });
        
    }
}

const listCommitPostSucesso = (list, dispatch) => {
    dispatch(
        {
            type: IMPORT_LIST_COMMIT_POST_SUCCESS,
            payload: list
        }
    );
...
const listCommitPostErro = (msg, dispatch) => {
    dispatch(
        {
            type: IMPORT_LIST_COMMIT_POST_ERRO,
            payload: msg
        }
    );
